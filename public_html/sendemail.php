...
if(isset($_POST["fname"])) {
	...
	//Headers
	$to = "abedasarl@gmail.com";
    $subject = 'Informations ABEDA SARL';
	$headers  = 'Depuis : <ayyaz@gmail.com>' . "\r\n";
    ...
    echo ($send_email) ? '<div class="success alert alert-success text-center rounded-pill mt-2">Email envoyé avec succès.</div>' : 'Error: Erreur envoie mail.';
}
else
{
	echo '<div class="failed alert alert-danger text-center rounded-pill mt-2">Erreur : Email pas envoyé.</div>';
}
?>